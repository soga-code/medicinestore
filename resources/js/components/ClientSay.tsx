            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                <div className="p-10 border-2 rounded-3xl text-start">
                    <div className="flex flex-col-2 gap-4">
                        ...
                        <h4 className="font-bold sm:text-lg mt-2">Ayomide Ayoola</h4>
                    </div>
                    <p className='text-sm sm:text-base'>Lorem, ipsum dolor sit amet consectetur adipisicing elit Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                </div>
                <div className="p-10 border-2 rounded-3xl text-start">
                    <div className="flex flex-col-2 gap-4">
                        <img src="/images/client2.jpg" alt="Client 2" className='h-10 w-10 rounded-full mb-2' />
                        <h4 className="font-bold sm:text-lg mt-2">Michael Tunde</h4>
                    </div>
                    <p className='text-sm sm:text-base'>Lorem, ipsum dolor sit amet consectetur adipisicing elit Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                </div>
                <div className="p-10 border-2 rounded-3xl text-start">
                    <div className="flex flex-col-2 gap-4">
                        ...
                        <h4 className="font-bold sm:text-lg mt-2">James Jackson</h4>
                    </div>
                    <p className='text-sm sm:text-base'>Lorem, ipsum dolor sit amet consectetur adipisicing elit Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                </div>
            </div>
